...
(cl:defmethod cl:initialize-instance :after ((m <motor_serial-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'motor_serial-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name MainRobot-srv:<motor_serial-request> is deprecated: use MainRobot-srv:motor_serial-request instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <motor_serial-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader MainRobot-srv:id-val is deprecated.  Use MainRobot-srv:id instead.")
  (id m))

(cl:ensure-generic-function 'cmd-val :lambda-list '(m))
(cl:defmethod cmd-val ((m <motor_serial-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader MainRobot-srv:cmd-val is deprecated.  Use MainRobot-srv:cmd instead.")
  (cmd m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <motor_serial-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader MainRobot-srv:data-val is deprecated.  Use MainRobot-srv:data instead.")
  (data m))
...
(cl:defmethod cl:initialize-instance :after ((m <motor_serial-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'motor_serial-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name MainRobot-srv:<motor_serial-response> is deprecated: use MainRobot-srv:motor_serial-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<motor_serial-response>)))
  ...
  "MainRobot/motor_serialResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'motor_serial-response)))
  "Returns string type for a service object of type 'motor_serial-response"
  "MainRobot/motor_serialResponse")
